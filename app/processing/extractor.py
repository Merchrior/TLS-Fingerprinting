...
def extract_client_hello_records(
    ...
    for row in reader:
        ...
        record = {
            ...
            "src_port": safe_int(row.get("tcp.srcport")),
            "dst_port": safe_int(row.get("tcp.dstport")),
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Extract TLS ClientHello metadata and JA3 hashes from PCAP")
    ...
    parser.add_argument("--tshark-path", dest="tshark_path", default=None, help="Optional full path to tshark.exe")
