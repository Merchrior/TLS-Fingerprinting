...
class TLSPredictor:
    """
    Hybrid karar motorunun sade sürümü.

    Akış:
    1. Fast Path:
       - JA3 hash whitelist'te varsa direkt known döner.
    2. Unknown Path:
       - Basit heuristic ile bir aday tahmin üretir.
       - Candidate tablosuna yazar.
    """
    ...
    def predict(self, record: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 2) UNKNOWN PATH: heuristic candidate inference
    ...
    def _heuristic_predict(
        ...
        # Rule 4: Messaging / mobile push style candidate
        ...
        # Rule 6: If we at least have a structured JA3
